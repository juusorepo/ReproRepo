...
if (file.exists(here("01-data/raw/babysteps-rawdata.csv"))) {
  babysteps <- read.csv(here("01-data/raw/babysteps-rawdata.csv"))
} else {
  babysteps <-
    read.csv(
...
-   **Action Steps:** Run the code below to create an EDA report. See results in Notebooks folder or [here](04-notebooks/EDA-report-initial-2024-03-18.html).
