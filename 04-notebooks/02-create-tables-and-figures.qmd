...
# Print a preview of the flextable 
tbl
```
...
There are several alternatives for the modelsummary + flextable combination. Some of these are listed in Resources page. You may also create a table more 'manually' and then use flextable for final customization and exporting.
