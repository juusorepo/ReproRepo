...
-   Copy and run the below code **in RStudio** **console** **window** to download this notebook to your project folder. (or download [the zip file](https://github.com/juusorepo/ReproRepo/raw/master/babysteps-for-reproducibility.zip) and extract it to your project folder).
